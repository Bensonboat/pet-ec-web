...
export default {
  ...
  //       this.innerProductData.spec.spec_options = this.innerProductData.spec.spec_options.map(
  //         (item) => {
  //           item.selected = false;
  //           return item;
  //         }
  //       );
  //       this.innerProductData.spec.spec_options[index].selected = !this
  //         .innerProductData.spec.spec_options[index].selected;

  //       if (this.innerProductData.spec.spec_options[index].selected) {
  //         this.selectItemPrice = this.innerProductData.spec.spec_options[
  //           index
  //         ].price;
  //       }
  //     },
